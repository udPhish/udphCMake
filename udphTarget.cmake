...
function(check_target TARGET_NAME)
    ...
    if(${ARGC} GREATER 1)
        if("${TARGET_VERSION}" VERSION_LESS "${ARGV1}")
            message(FATAL_ERROR "Target ${TARGET_NAME} (${TARGET_VERSION}) does not meet the minimum version requirement (${ARGV1}).")
        endif()
    endif()
    if(${ARGC} GREATER 2)
        if("${TARGET_VERSION}" VERSION_GREATER "${ARGV2}")
            message(FATAL_ERROR "Target ${TARGET_NAME} (${TARGET_VERSION}) does not meet the maximum version requirement (${ARGV2}).")
        endif()
    endif()
endfunction()
