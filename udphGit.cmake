...
function(git_update_submodule submodule_dir)
	message(STATUS "Updating submodule ${submodule_dir} in ${PROJECT_NAME}")
	...
	if("${SUBMODULE_CURRENT_COMMIT}" STREQUAL "${SUBMODULE_NEW_COMMIT}")
		message(STATUS "Submodule ${submodule_dir} in ${PROJECT_NAME} up to date.")
	else()
		message(STATUS "Submodule ${submodule_dir} in ${PROJECT_NAME} switched from ${SUBMODULE_CURRENT_COMMIT} to ${SUBMODULE_NEW_COMMIT}")
	endif()
endfunction()
